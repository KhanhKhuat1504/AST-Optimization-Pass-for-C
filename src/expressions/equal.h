...
class ASTExpressionEqual : public ASTExpression
{
...
public:
    ...
    ASTExpressionEqual(std::unique_ptr<ASTExpression> a1, std::unique_ptr<ASTExpression> a2) : a1(std::move(a1)), a2(std::move(a2)) {}
    ...
    {
        return std::make_unique<ASTExpressionEqual>(std::move(a1), std::move(a2));
    }
